...
Note that given any set $\mc X$ which is $(\lambda, \nu, \eta)$-nice, there can exist different sets $\mc B$ which satisfy the separation, dense and sparseness conditions. In this section, we wish to examine conditions under which the solution is `unique' and under which condition multiple solutions are possible. 
