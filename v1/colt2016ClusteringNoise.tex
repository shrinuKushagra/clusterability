...
\caption{$\mc X \subseteq \mathbb{R}$ such that no algorithm can capture all the $\alpha$-center $t$-min $r$-max proximal subsets of $\mc X$. For this example, we fix $r = 1$ for simplicity.}
