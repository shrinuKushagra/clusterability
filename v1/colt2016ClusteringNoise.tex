...
% In this paper, we restrict our centers to be a part of the data set $\mc X$. 
...
%In what follows, we will explain the notions of clusterability that we consider in this paper.
%\subsection{Notions of Clusterability}
%Assume that we are given a clustering instance $\mc X$ drawn from some metric space $(\mb M, d)$ and the number of clusters $k$.
