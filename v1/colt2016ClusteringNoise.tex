...
\todo In the past few years, different notions of clusterability has been introduced. The main goal of all these works has been to show that clustering cane be handled much easier in the scenarios that we assume there is some structure on the data. Briefly mention literature review.
...
There has been two major quantitative measures of noise robustness clustering so far: The first notion is closely related to approximation algorithms: It says that if $\epsilon$ fraction of the data is noise, then 
