...
%In the \textbf{Proper} setting, we restrict our centers to be a part of the data set $\mc X$. In the \textbf{Steiner} setting, the centers are allowed to be a part of the metric space $\mb M$. In this paper, we will be working in the proper setting.
