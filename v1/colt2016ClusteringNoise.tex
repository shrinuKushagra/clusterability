...
\todo %In the past few years, different notions of clusterability has been introduced. The main goal of all these works has been to show that clustering can be handled much easier in the scenarios that we assume there is some structure on the data. Briefly mention literature review.
