...
\vspace{-0.13in}\begin{definition}[$r(\mc C_{\mc X})$ , $t(\mc C_{\mc X})$] Given a clustering $\mc C_{\mc X} = \{C_1, \ldots, C_k\}$ of the set $\mc X$ induced by centers $c_1, \ldots, c_k \in \mb M$. 
