...
\begin{proof}
Define $\mc X \subseteq \mathbb{R}$ as follows. Let $t' = \frac{t}{2}-1$. Let $O_1 = \union_{i=0}^6 P_{t'}(2ir)$ and $O_2 = \union_{i=0}^5 P_2(r+2ir)$. For $3\le i\le k$, define $B_i = P_t(22r+ir)$. Now, let $\mc X = \{O_1 \union O_2 \union B_3 \union \ldots \union B_k\}$. The set is also shown in Fig. \ref{fig:nosparsealg}.
